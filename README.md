...
## Plugins
  1. https://es.wordpress.org/plugins/
  2. Plugins pago https://codecanyon.net/category/wordpress
  3. Plugins recomendados por Raiola https://raiolanetworks.es/blog/plugins-para-wordpress-que-usamos-y-recomendamos-en-2016/
  4. Listado plugins recomendados https://premium.wpmudev.org/blog/essential-wordpress-plugins/

## Roles y capacidades
  1. https://codex.wordpress.org/es:Roles_y_Capacidades
  2. Administrador - Editor - Autor - Colaborador - Suscriptor
  
## Multiidiomas WPML
  1. https://www.ciudadano2cero.com/varios-idiomas-wordpress-wpml/
  2. Polylang alternativa a WPML https://raiolanetworks.es/blog/polylang-alternativa-wpml-wordpress/

## Backups
  1. Los mejores plugins para hacer copias de seguridad 
    https://raiolanetworks.es/blog/plugins-backup-copia-seguridad-wordpress/
  2. Tutorial UpDraftPlus https://www.lifestylealcuadrado.com/tutorial-updraftplus/
  
## Actualizar WordPress
  1. https://www.webempresa.com/blog/actualizar-wordpress-manual-o-automaticamente.html
  
## Errores comunes en WordPress
  1. https://codex.wordpress.org/Common_WordPress_Errors

## Migrar WordPress
  1. https://www.ciudadano2cero.com/guia-migrar-wordpress/
  
## Gestión de comentarios
  1. https://www.webempresa.com/blog/la-gestion-de-comentarios-en-wordpress.html
  2. Disqus https://raiolanetworks.es/blog/instalar-y-configurar-disqus-en-wordpress/

## Trackbacks and Pingbacks
  1. https://make.wordpress.org/support/user-manual/building-your-wordpress-community/trackbacks-and-pingbacks/
  
## Spam en WordPress
  1. https://www.webyseo.es/5-consejos-plugins-combatir-spam-wordpress

## Configurando WP-CONFIG
  1. https://codex.wordpress.org/Editing_wp-config.php

## Configura herramientas SEO
  1. Yoast SEO https://www.blogpocket.com/2016/08/17/configurar-yoast-seo/
  2. Analytics https://es.wordpress.org/plugins/google-analytics-dashboard-for-wp/
  3. Wordfence https://www.lifestylealcuadrado.com/wordfence-seguridad-wordpress/
  4. Vikinguard https://raiolanetworks.es/blog/vikinguard-monitorizar-rendimiento-la-disponibilidad-wordpress/

## Plan - Do - Check - Act
  1. https://www.blogpocket.com/2016/08/28/mantenimiento-de-wordpress/
  2. Seguridad https://www.webempresa.com/wordpress/tutorial-seguridad-en-wordpress-guia-completa.html
  3. Google Webmaster Tools 'Search console' https://josefacchin.com/google-webmaster-tools-herramientas-tutorial/
  4. Tiempos de carga https://kinsta.com/es/blog/ttfb/?utm_campaign=fbboost&utm_medium=cpc&utm_source=facebook&utm_content=ttfb
  5. w3 Total Cache https://raiolanetworks.es/blog/guia-basica-de-configuracion-de-w3-total-cache-en-wordpress/
## WooCommerce
  1. Descarga plugin, documentación https://woocommerce.com/
